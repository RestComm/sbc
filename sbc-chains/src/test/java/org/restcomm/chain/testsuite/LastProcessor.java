 ...
 * @date    11/6/2016 17:26:30
 * @class   LastProcessor.java
 *
 */
public class LastProcessor extends DefaultEndpointProcessor  implements ProcessorCallBack {

	private static transient Logger LOG = Logger.getLogger(LastProcessor.class);
	
	private String name="Last Processor";
	
	public LastProcessor(ProcessorChain processorChain) {
		super(processorChain);
		
	}

	
	public LastProcessor(String name, ProcessorChain processorChain) {
