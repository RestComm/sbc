...
private boolean ok=true;
	...
	public void run() {
		try {
			cpc.process(new StringBufferImmutableMessage(Thread.currentThread().getName()));
	...
	public void onProcessorEnd(Message message, Processor processor) {
		...
		LOG.info(">>>>onChainEnd() "+processor.getType()+"("+processor.getName()+")["+message.getContent()+"]-"+message);	
