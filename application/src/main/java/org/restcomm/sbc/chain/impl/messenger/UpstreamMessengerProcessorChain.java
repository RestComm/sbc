 ...
 * @date    17 feb. 2017 18:41:40
 * @class   UpstreamMessengerProcessorChain.java
 *
 */
public class UpstreamMessengerProcessorChain extends DefaultSerialProcessorChain implements ProcessorCallBack, ProcessorListener {

	private static transient Logger LOG = Logger.getLogger(UpstreamMessengerProcessorChain.class);
	private String name="Upstream MESSAGE Processor Chain";

	public UpstreamMessengerProcessorChain() {
		Processor c1 = new IncomingDPIProcessor(this);
		c1.addProcessorListener(this);	
		Processor c2 = new MessengerDPIProcessor(this);
		...
		Processor c6 = new MessengerProcessor(this);
