 ...
 * @date    17 feb. 2017 18:34:08
 * @class   DownstreamMessengerProcessorChain.java
 *
 */
public class DownstreamMessengerProcessorChain extends DefaultSerialProcessorChain implements ProcessorCallBack, ProcessorListener  {
	...
	public DownstreamMessengerProcessorChain() {
		...
		Processor c4 = new MessengerProcessor(this);
