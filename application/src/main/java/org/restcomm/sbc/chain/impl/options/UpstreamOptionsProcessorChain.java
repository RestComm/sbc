 ...
 *
 */
public class UpstreamOptionsProcessorChain extends DefaultSerialProcessorChain implements ProcessorCallBack, ProcessorListener {

	private static transient Logger LOG = Logger.getLogger(UpstreamOptionsProcessorChain.class);
	private String name="Upstream OPTIONS Processor Chain";

	public UpstreamOptionsProcessorChain() {
