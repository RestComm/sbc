 ...
 *
 */
public class DownstreamInviteProcessorChain extends DefaultSerialProcessorChain implements ProcessorCallBack, ProcessorListener  {
	...
	public DownstreamInviteProcessorChain() {
		...
		Processor c1 = new InviteProcessor(this);
